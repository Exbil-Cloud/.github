...
Thanks for taking the time to contribute to a Exbil Cloud project.
...
1. Create a branch from the default branch (fork first if you do not have
   write access).
...
(e.g. "Add domain endpoint", not "Added domain endpoint").
